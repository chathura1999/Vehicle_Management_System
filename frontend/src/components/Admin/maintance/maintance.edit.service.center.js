...
function ServiceCenterEdit() {
      ...
      function Edit(e){
            ...
            axios.put(global.APIUrl+"/service_Center/Service_centerUpdate/"+id,Service_centerUpdate).then(() =>{
                        ...
                        <MDBCol sm='6'>
                            ...
                            <MDBCardBody  className="bg-light">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" disabled  value={location} onChange={(e) =>{
